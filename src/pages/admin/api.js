...
export default {
  ...
  deleteCourseById(id) {
    return ajax('admin/groups', 'delete', {
      params: {
        id
      }
    })
  },
  editCourseById(id, group_name) {
    return ajax('admin/groups', 'put', {
      data: {
        "group_id": id,
  ...
  getHomework(group_id, homework_id) {
  ...
  createHomework(group_id, name, deadline) {
  ...
  addProblemtoHw(homework_id, problem_id) {
    return ajax('admin/add_problem_hw', 'post', {
      data: {
        "homework_id": homework_id,
  ...
  deleteProblemfromHw(homework_id, problem_id) {
    return ajax('admin/remove_problem_hw', 'post', {
      data: {
        "homework_id": homework_id,
        "problem_id": problem_id
      }
  ...
  getachieveproblemstudent(group_id, homework_id, problem_id) {
    return ajax('admin/pass_student_list', 'post', {
      data: {
        "homework_id": homework_id,
        "problem_id": problem_id,
        "group_id": group_id
  ...
  codecheck(al_achieve_students, problem_id, check_student_id, homework_id, codecheckrate) {
    return ajax('admin/code_check', 'post', {
      data: {
        al_achieve_students,
        problem_id,
        check_student_id,
        homework_id, codecheckrate
      }
    })
  }
}
